					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>E</span>-KUPOVINA</h1>
									<h2>Dobrodosli</h2>
									<p>Na ovom sajtu mozete porucivati proizvode. </p>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-KUPOVINA</h1>
									<h2>Kako kupiti?</h2>
									<p>Potrebno je da se registrujete. Nakon registracije popunite svoju adresu i kontakt telefon (na koju ce Vam stizati proizvodi koje budete porucivali).
									Jednostavnim klikom na "Dodaj u korpu" mozete izabrani artikal poruciti. Nasi administratori ce Vas nazvati telefonom da bi potvrdili da ste bas vi to porucili. Zbog toga proverite validnost Vasih podataka.</p>
