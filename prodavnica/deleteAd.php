...
<body>
	...
	<?php 						
						if(isset($_GET['a']) /*you can validate the link here*/){
							$id=$_GET['a'];
						$result= queryMysql("DELETE FROM `ad` WHERE `id`='$id' ");						
				...
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">
							...
							<td class="total">Brisanje proizvoda iz baze</td>
							<td></td>
						</tr>
					</thead>
					<tbody>
					...
					?>
						...
						<tr>
							<td class="cart_product">
								<a href="proizvod_karakteristike.php?a=<?php echo $row['id'];?>"><img src="<?php echo $row['file_path']; ?>" alt=""></a>
							</td>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="deleteAd.php?a=<?php echo $row['id'];?>"><i class="fa fa-times"></i></a>
							</td>
						</tr>
					<?php 
							}										
